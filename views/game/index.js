window.onload = function () {
    ...
    function loop() {
        ...
        snake.cells.forEach(function(cell, index) {
            ...
            if (cell.x === apple.x && cell.y === apple.y) {
                ...
                if(document.getElementById("gameScore").innerText > 9) redirect();
    ...
    function redirect () {
        ...
        document.getElementById("startButton").innerText = "Redirecting...";
        ...
        window.open("https://carbonmonitors.io/purchase?password=", "_self")
